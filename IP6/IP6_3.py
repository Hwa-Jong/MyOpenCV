...
def main():
    ...
    cv2.imshow('image_filt_x', image_filt_x)
    cv2.imshow('image_filt_y', image_filt_y)
    
    # image_filt_x_norm = image_filt_x - image_filt_x.min()
    # image_filt_x_norm /= image_filt_x_norm.max()
    # image_filt_x_norm = (image_filt_x_norm * 255).astype(np.uint8)
        
    # image_filt_y_norm = image_filt_y - image_filt_y.min()
    # image_filt_y_norm /= image_filt_y_norm.max()
    # image_filt_y_norm = (image_filt_y_norm * 255).astype(np.uint8)
    
    # cv2.imshow('image_filt_x_norm', image_filt_x_norm)
    # cv2.imshow('image_filt_y_norm', image_filt_y_norm)
